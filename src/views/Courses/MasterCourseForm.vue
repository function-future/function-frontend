    ...
    <div class="edit-container">
      <div class="title">
        <BaseInput autofocus
                   class="input-title"
                   inputType="title"
                   v-model="masterCourseData.title"
                   placeholder="Master Course Title"
      ...
      <div class="description">
        <mavon-editor class="editor"
                      placeholder="Master Course Description"
                      language="en"
                      v-model="masterCourseData.description"
                      v-validate.disable="'required'"
                      :toolbars="toolbars"
                      name="description">
        </mavon-editor>
      ...
      <div class="action">
        ...
        <div class="action-button">
          <BaseButton type="submit" buttonClass="button-save" @click="sendMasterCourse" :disabled="isSubmitting || uploadingFile">Save</BaseButton>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="./js/master-course-form.js"></script>
